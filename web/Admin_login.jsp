                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <form class="form-wrapper" method="post" action="admin">
                                                <center><h4>Admin Login</h4></center>
                                                <label>Email</label>
                                                <input type="text" class="form-control" placeholder="Enter Your Mail ID" required="required" name="name">
                                                <label>Password</label>
                                                <input type="password" class="form-control" placeholder="Enter Your Password" required="required" name="pass">
                                                <center><button type="submit" class="btn btn-sucess">Login</button></center>
                                            </form>
                                        </div>
                                    </div>
