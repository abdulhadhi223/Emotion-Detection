                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <form class="form-wrapper" method="post" action="user_reg" enctype="multipart/form-data">
                                                <center><h4>User Register</h4></center>
                                                <label>Name :</label>
                                                <input type="text" class="form-control" placeholder="Enter Your Name" required="required" name="username">
                                                <label>D O B :</label>
                                                <input type="date" class="form-control" placeholder="Enter Your DOB" required="required" name="dob">
                                                <label>Gender :</label>
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Your Phone No" required="required" name="phone">
                                                <label>Address :</label>
                                                <input type="text" class="form-control" placeholder="Enter Your Address" required="required" name="address">
                                                <label>Profile Picture :</label>
                                                <input type="file" class="form-control" name="profile_pic">
                                                <label>Password :</label>
                                                <input type="password" class="form-control" placeholder="Enter Your Password" required="required" name="pass">
                                                <center><button type="submit" class="btn btn-sucess">Sign Up</button></center>
                                            </form>
                                        </div>
                                    </div>
