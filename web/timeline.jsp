                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular"><strong>Timeline</strong></span><br/></h1></center>
                                            <table id="customers">
                                                <%                                                //while(rs2.next()){
                                                    //fid=rs2.getInt("fid");
...
%>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                    <td>
                                                        <label><span>Tweet:</span> </label><p><input readonly="" value="<%=rs1.getString("msg")%>" style="width: 400px; height: 90px; border-color: white; color: black"></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td> 
                                                        <img src="img_tweet?id=<%=rs1.getInt("tid")%>" alt="" width="400" height="300" />
                                                    </td>
                                                </tr>
