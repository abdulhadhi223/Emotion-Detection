                    ...
                    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link active" href="User_Home.jsp">Home</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular"><strong>Welcome <%=name.toUpperCase()%>!</strong></span><br/></h1></center>
                                            <img src="images/uhome1.jpg" width="700" height="550">
                                        </div>
                                    </div>
