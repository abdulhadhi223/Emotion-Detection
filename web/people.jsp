                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular"><strong>All People</strong></span><br/></h1></center>
                                            <table id="customers">
                                                <th>Profile</th>
                                                <th>User Name</th>
                                                <th>Status</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><font style="font-family: cursive; font-size: 16px; color: blue"><%=fname%></td>
                                                ...
                                                <tr>
                                                    <td><img style="border-radius: 50%;" src="Getimage?id=<%=fid%>" width="120" height="120" ><br></td>
                                                    <td><font style="font-family: cursive; font-size: 16px; color: blue"><%=fname%></td>
                                                    <td><a href="request.jsp?id=<%=rid%>" class="btn btn-link"><font size="3"><strong>Follow</strong></font></a><br></td>
                                                </tr>                         
