                    ...
                    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="user_tweets.jsp">User Tweets</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="tweet_analysis.jsp">Tweet Analysis</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular"><strong>User Analysis</strong></span><br/></h1></center><br>
                                            <center><table id="customers">
                                                    <tr>
                                                        <th>User ID</th>
                                                        <th>Name</th>
                                                        <th>Tweet's</th>
                                                        <th><center>Tweet Emotion</center></th>
                                                    </tr>
                                                    <%
                                                        ...
                                                        try {
                                                            ResultSet rs = st.executeQuery("SELECT * FROM tweet where status !='NULL'");
                                                            while (rs.next()) {
                                                                int emotion = rs.getInt("status");
                                                                String temp ="";
                                                                if(emotion == 1){
                                                                    temp = "Happy";                                                               
                                                                }
