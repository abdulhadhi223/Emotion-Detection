                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular">Message To <strong><%=fname%></strong></span><br/></h1></center>
                                            <form action="Msg" method="post"  enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea required="" style="width: 360px;height: 80px;color: black;" class="form-group" name="msg" placeholder="Type Message Here!"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label>Send Image :</label><br>
                                                    <input type="file" class="form-group" name="file">
                                                </div>
                                                <center><button type="submit" class="btn btn-default btn-lg">SEND</button></center>
                                            </form> 
                                        </div>
                                    </div>
