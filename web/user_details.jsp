                    ...
                    <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="user_details.jsp">User Details</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-lg-12 col-lg-12 col-lg-12">
                                <div class="page-wrapper">
                                    <div class="row">
                                        <div class="container">
                                            <center><h1 class="title-section"><span class="title-regular"><strong>User Details</strong></span><br/></h1></center><br>
